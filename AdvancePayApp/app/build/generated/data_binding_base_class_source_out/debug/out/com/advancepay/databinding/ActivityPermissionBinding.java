...
public final class ActivityPermissionBinding implements ViewBinding {
  ...
  private ActivityPermissionBinding(@NonNull ConstraintLayout rootView,
      @NonNull MaterialButton btnEnable, @NonNull ImageView ivIcon, @NonNull TextView tvDescription,
  ...
  public static ActivityPermissionBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.btnEnable;
      MaterialButton btnEnable = ViewBindings.findChildViewById(rootView, id);
      if (btnEnable == null) {
        break missingId;
      }
      ...
      return new ActivityPermissionBinding((ConstraintLayout) rootView, btnEnable, ivIcon,
