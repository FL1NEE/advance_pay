...
public final class ItemNotificationBinding implements ViewBinding {
  ...
  private ItemNotificationBinding(@NonNull MaterialCardView rootView, @NonNull TextView tvAmount,
      @NonNull TextView tvAppName, @NonNull TextView tvText, @NonNull TextView tvTime,
  ...
  public static ItemNotificationBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemNotificationBinding((MaterialCardView) rootView, tvAmount, tvAppName, tvText,
          tvTime, tvTitle);
    }
